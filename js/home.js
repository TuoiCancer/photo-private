...
const TRANSLATE = {
    vn: {
        ...
        description: "Nhận biết ngay các loại cây xung quanh bạn và học cách chăm sóc chúng.",
        contentTitle1: "LeafSnap with a snap",
        contentDescription1: "Chỉ cần chụp hoặc tải lên một bức ảnh của bất kỳ loài thực vật nào, nhận được kết quả ID thực vật ngay lập tức và chính xác với công nghệ trí tuệ nhân tạo mang tính cách mạng của chúng tôi.",
        contentButton1: "Tôi cần cái này",
        contentTitle2: "Tự động chẩn đoán sự cố",
        contentDescription2: "Chụp ảnh bộ phận bị bệnh của cây, tìm nguyên nhân và đề xuất điều trị.",
        ...
        contentDescription5: "Nhận lời khuyên làm vườn và gỡ rối các vấn đề về vườn của bạn với các chuyên gia thực vật của chúng tôi.",
        contentButton5: "Tham khảo ý kiến ​​chuyên gia",
        contentTitle6: "Cơ sở dữ liệu siêu phong phú",
        contentDescription6: "Truy cập vào cơ sở dữ liệu khổng lồ về thực vật đang phát triển và nhận mọi thứ bạn muốn biết về cây, từ tần suất tưới nước đến kiểm soát sâu bệnh, từ tài liệu đến thông tin thú vị.",
        contentButton6: "Tìm kiếm cây trồng",
        contentTitle7: "Nhận LeafSnap ngay bây giờ",
        contentDescription7: "Hãy dùng thử Ứng dụng LeafSnap trên điện thoại của bạn và xác định hơn 30000 loài thực vật!",
        contentDescription8: "Xem thêm thông tin về thực vật, tham gia cộng đồng tuyệt vời của chúng tôi và khám phá những điều thú vị trên khắp thế giới trong Ứng dụng.",
        term: "Điều khoản",
        privacy: "Chính sách",
        contact: "Liên hệ",
    ...
    en: {
        ...
        description: "Instantly identify plants around you and learn how to care for them.",
        contentTitle1: "LeafSnap with a snap",
        contentDescription1: "Simply take or upload a photo of any plant, get instantaneous and accurate plant ID results with our revolutionary artificial intelligence technology.",
        contentButton1: "I Need This",
        contentTitle2: "Auto problem diagnosis",
        contentDescription2: "Take picture of sick part of plants, get problem causes and treatment suggestions.",
        ...
        contentDescription5: "Get gardening advice and troubleshoot your garden problems with our plant experts.",
        contentButton5: "Consult expert",
        contentTitle6: "Super rich database",
        contentDescription6: "Get access to a huge growing database of plant and get everything you want to know about the plant, from watering frequency to pest and disease control, from literature to fun fact.",
        contentButton6: "Search plants",
        contentTitle7: "Get LeafSnap now",
        contentDescription7: "Try out LeafSnap App on your phone and Identify more than 30000+ plant species!",
        contentDescription8: "See more info about plants, join our amazing community and explore snaps around the world in the App.",
        term: "Term of Use",
